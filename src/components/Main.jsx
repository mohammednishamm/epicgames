...
<IoCloseOutline className='text-white fs-3 me-2'/>
       ...
       <p className='text-white epicfont1 text-center fs-6 fw-light'>Create, play, and battle with friends for free in Fortnite. Be the last player standing in Battle Royale and Zero Build, experience a concert or live event, or discover over a million creator made games, including racing, parkour, zombie survival, and more. Each Fortnite island has an individual age rating so you can find the one that's right for you and your friends. Find it all in Fortnite ... Drop In.</p>
       <button className='bg-light    pt-2 pb-2 visitbutton'>Visit Website </button>
    </div>
  )
}
